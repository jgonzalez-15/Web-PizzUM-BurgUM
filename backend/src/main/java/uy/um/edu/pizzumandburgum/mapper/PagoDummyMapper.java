...
public class PagoDummyMapper {
    ...
    public PagoDummyResponseDTO toResponseDTO(PagoDummy pagoDummy) {
        return new PagoDummyResponseDTO(pagoDummy.getCodigoTransaccion(),pagoDummy.getMonto(),pagoDummy.getFechaPago(),pagoDummy.getEstadoPago(),pagoDummy.getPedido().getId());
    }
}
